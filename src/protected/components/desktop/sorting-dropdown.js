class SortingDropdown extends HTMLElement {
    constructor() {
        ...
        const styles = /*css*/`
            ...
            .dropdown-item:hover, .dropdown-button:hover, .order-button:hover {
                cursor: pointer;
        ...
        this.$shadowRoot.find('.dropdown-item').on('click', event => {
            ...
            this.$shadowRoot.find('.dropdown-button > h5').text(dropdownItemDiv.text())
    ...
    connectedCallback() {
        ...
        const dropdownButtonTitle = this.$shadowRoot.find('.dropdown-button>h5')
    ...
    setOption(option) {
        this.$shadowRoot.find('.dropdown-button > h5').text(option)
